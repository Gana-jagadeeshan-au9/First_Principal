...
import shape from "./../images/header-shape.svg";
    ...
    return (
        <div className="Home">
            <header className="header-area">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <nav className="navbar navbar-expand-lg">
                                    ...
                                    <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarOne"
                ...
                <div id="home" className="header-hero bg_cover" style={inStyle}>
                    <div className="container">
                            ...
                            <div className="col-xl-8 col-lg-10">
                                <div className="header-content text-center">
                                    ...
                                    <ul className="header-btn rounded-buttons">
                                        ...
                                        <li><a className="main-btn rounded-four video-popup"
                                            href="../../watch.html?v=r44RKWyfcFw">WATCH THE VIDEO <i
                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                                    ...
                                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g id="bottom-part">
                                            <g id="Group_747" data-name="Group 747">
                                                <path id="Path_294" data-name="Path 294" className="cls-1 color-1"
                                                    d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_297" data-name="Path 297" className="cls-2 color-1"
                                                    d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_296" data-name="Path 296" className="cls-3 color-1"
                                                    d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_295" data-name="Path 295" className="cls-4 color-1"
                            ...
                            <div className="single-pricing pro mt-40">
                                ...
                                <div className="buttom-shape">
                                    ...
                                    .cls-4 {
                                        ...
                                        <g id="bottom-part">
                                            <g id="Group_747" data-name="Group 747">
                                                <path id="Path_294" data-name="Path 294" className="cls-1 color-2"
                                                    d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_297" data-name="Path 297" className="cls-2 color-2"
                                                    d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_296" data-name="Path 296" className="cls-3 color-2"
                                                    d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z"
                                                    transform="translate(0 0)"></path>
                                                <path id="Path_295" data-name="Path 295" className="cls-4 color-2"
                                                    d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z"
                                                    transform="translate(0 0)"></path>
                                            </g>
                                        </g>
                        ...
                        <div className="col-lg-4 col-md-7 col-sm-9">
                            ...
                            <g id="bottom-part">
                                <g id="Group_747" data-name="Group 747">
                                    <path id="Path_294" data-name="Path 294" className="cls-1 color-3"
                                        d="M0,24.21c120-55.74,214.32,2.57,267,0S349.18,7.4,349.18,7.4V82.35H0Z"
                                        transform="translate(0 0)"></path>
                                    <path id="Path_297" data-name="Path 297" className="cls-2 color-3"
                                        d="M350,34.21c-120-55.74-214.32,2.57-267,0S.82,17.4.82,17.4V92.35H350Z"
                                        transform="translate(0 0)"></path>
                                    <path id="Path_296" data-name="Path 296" className="cls-3 color-3"
                                        d="M0,44.21c120-55.74,214.32,2.57,267,0S349.18,27.4,349.18,27.4v74.95H0Z"
                                        transform="translate(0 0)"></path>
                                    <path id="Path_295" data-name="Path 295" className="cls-4 color-3"
                                        d="M349.17,54.21c-120-55.74-214.32,2.57-267,0S0,37.4,0,37.4v74.95H349.17Z"
                                        transform="translate(0 0)"></path>
                                </g>
                            </g>
